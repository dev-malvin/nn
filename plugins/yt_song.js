...
const { v4: uuidv4 } = require('uuid'); // For session-specific button IDs
...
malvin(
    ...
    async (malvin, mek, m, { text, reply }) => {
        try {
            ...
            const caption = `╭──〔 🎉 ᴍᴀʟᴠɪɴ xᴅ sᴏɴɢ ᴅʟ 🎉 〕──
│
...
╰──〔 ✨ ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴍᴀʟᴠɪɴ xᴅ 〕──`;
            ...
            const sessionId = uuidv4(); // Unique session ID for button handling
            ...
            const sentMsg = await malvin.sendMessage(mek.chat, buttonsMessage, { quoted: mek });
